...
public class GlassEntity extends Entity {
    ...
    public GlassEntity(Game g, String r, int newX, int newY, int moveSpeed) {
    ...
    public void collidedWith(Entity other) {
        ...
        if (other instanceof cosEntity) {
            ...
            if (returnedGlass == 3 || returnedGlass == 6 || returnedGlass == 2) {
                ...
                GlassEntity shot = new GlassEntity(game, "sprites/emptyGlass.png", posX, posY, 90);
